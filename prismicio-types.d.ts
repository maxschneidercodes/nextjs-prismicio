...
/**
 * Primary content in *HeroWithImage → Primary*
 */
export interface HeroWithImageSliceDefaultPrimary {
  /**
   * Text field in *HeroWithImage → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_image.primary.text
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  text: prismic.RichTextField;
}
...
/**
 * Primary content in *HeroWithImage → Items*
 */
export interface HeroWithImageSliceDefaultItem {
  /**
   * Image field in *HeroWithImage → Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_with_image.items[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;
}
...
/**
 * Default variation for HeroWithImage Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type HeroWithImageSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<HeroWithImageSliceDefaultPrimary>,
  Simplify<HeroWithImageSliceDefaultItem>
>;

/**
 * Slice variation for *HeroWithImage*
 */
type HeroWithImageSliceVariation = HeroWithImageSliceDefault;

/**
 * HeroWithImage Shared Slice
 *
 * - **API ID**: `hero_with_image`
 * - **Description**: HeroWithImage
 * - **Documentation**: https://prismic.io/docs/slice
 */
...
export interface MySliceSliceDefaultPrimary {
  /**
   * ProfileImage field in *MySlice → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: my_slice.primary.profileimage
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface MySliceSliceDefaultItem {
  /**
   * trest field in *MySlice → Items*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: my_slice.items[].trest
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
  trest: prismic.BooleanField;
}
 ...
 * Primary content in *MySlice → Primary*
 */
export interface MySliceSliceRtaaasPrimary {
  /**
   * ProfileImage field in *MySlice → Primary*
   *
   * - **Field Type**: Image
 ...
 * Primary content in *MySlice → Items*
 */
export interface MySliceSliceRtaaasItem {
  /**
   * trest field in *MySlice → Items*
   *
   * - **Field Type**: Boolean
...
/**
 * rtaaas variation for MySlice Slice
 *
 * - **API ID**: `rtaaas`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type MySliceSliceRtaaas = prismic.SharedSliceVariation<
  "rtaaas",
  Simplify<MySliceSliceRtaaasPrimary>,
  Simplify<MySliceSliceRtaaasItem>
>;

/**
 * Slice variation for *MySlice*
 */
type MySliceSliceVariation = MySliceSliceDefault | MySliceSliceRtaaas;
...
export interface TestSliceDefaultPrimary {
  /**
   * dasd field in *Test → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: test.primary.dasd
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  dasd: prismic.RichTextField;
}
...
export interface TestSliceDefaultItem {
  /**
   * ddd field in *Test → Items*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
   * - **API ID Path**: test.items[].ddd
   * - **Documentation**: https://prismic.io/docs/field#number
   */
  ddd: prismic.NumberField;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroWithImageSlice,
      HeroWithImageSliceDefaultPrimary,
      HeroWithImageSliceDefaultItem,
      HeroWithImageSliceVariation,
      HeroWithImageSliceDefault,
      ImageSlice,
      ...
      MySliceSliceRtaaasPrimary,
      MySliceSliceRtaaasItem,
      MySliceSliceVariation,
      MySliceSliceDefault,
      MySliceSliceRtaaas,
      QuoteSlice,
